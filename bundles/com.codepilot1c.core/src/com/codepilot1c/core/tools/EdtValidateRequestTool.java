    ...
    private static final String SCHEMA = """
            {
              ...
              "properties": {
                ...
                "operation": {
                  "type": "string",
                  "enum": ["create_metadata", "create_form", "extension_create_project", "extension_adopt_object", "extension_set_property_state", "add_metadata_child", "update_metadata", "delete_metadata", "mutate_form_model"],
