...
/**
 * Lists external-object EDT projects for a base configuration project.
 */
public class ExternalListProjectsTool implements ITool {
    ...
    private static final String SCHEMA = """
            {
              ...
              "properties": {
                ...
                "name_contains": {
                  "type": "string",
                  "description": "Case-insensitive external project name filter"
                },
                "limit": {
                  "type": "integer",
    ...
    public ExternalListProjectsTool() {
        this(new EdtExternalObjectService());
    }

    ExternalListProjectsTool(EdtExternalObjectService service) {
        this.service = service;
    }

    @Override
    public String getName() {
        return "external_list_projects"; //$NON-NLS-1$
    }

    @Override
    public String getDescription() {
        return "Lists external-object EDT projects for base configuration project."; //$NON-NLS-1$
    }
